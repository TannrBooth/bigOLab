...
function findFourthAgain(numbers) {
  return numbers[0]
}
...
const getNumbersSquared = numbersArr =>{
  let answers = []
  for (let i = 0; i < numbersArr.length; i++){
    answers.push(numbersArr[i]*numbersArr[i])
  }
  return answers
}
...
// ANSWER: countLetters will always return an object of the same size, regardless of the passed in string, where countLettersRoundTwo will return an object of varying size depending on the passed in string
